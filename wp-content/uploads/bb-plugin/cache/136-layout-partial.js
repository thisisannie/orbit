...
$('.uabb-row-separator').parents('html').css('overflow-x','hidden');});(function($){var document_width,document_height;var args={id:'61a403dc58684',pagination:'numbers',is_carousel:'grid',infinite:true,arrows:true,desktop:4,moduleUrl:'http://localhost/orbit/wp-content/plugins/bb-ultimate-addon/modules/blog-posts',medium:2,small:1,slidesToScroll:1,prevArrow:'fas fa-angle-left',nextArrow:'fas fa-angle-right',autoplay:false,autoplaySpeed:1000,dots:false,small_breakpoint:768,medium_breakpoint:992,equal_height_box:'yes',uabb_masonary_filter_type:'buttons',mesonry_equal_height:'no',blog_image_position:'top',element_space:'15'};jQuery(document).ready(function(){jQuery('.uabb-masonary-filters .uabb-masonary-current').trigger('click');var pattern=new RegExp('^\\d+$');var hashval=window.location.hash.substring(1);if(pattern.test(hashval)){if(hashval!=''){jQuery('.fl-node-61a403dc58684 .uabb-masonary-filters li').removeClass('uabb-masonary-current');jQuery('.fl-node-61a403dc58684 .uabb-masonary-filters li[data-filter=".uabb-masonary-cat-'+hashval+'"]').addClass('uabb-masonary-current');jQuery('.fl-node-61a403dc58684 .uabb-masonary-filters .uabb-masonary-filter-61a403dc58684.uabb-masonary-current').trigger('click');}}
